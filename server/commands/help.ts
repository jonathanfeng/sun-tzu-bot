const helpText = `Welcome to Sun-Tzu-Bot! Here are my commands:
!quote -- returns a random Sun Tzu quote (original purpose of bot)
!summonexodia <game> <opt: timer> -- starts a party-finder for game (must include game in argument), optional timer argument (minutes), tags everyone in the server with the role for the game
